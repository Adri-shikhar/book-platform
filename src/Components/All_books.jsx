                ...
                {books.map((book) => (
                    ...
                    >
                        ...
                        <h3 className="font-semibold text-lg mb-1">
                            <Link to={`${book.bookId}`} className="hover:underline">{book.bookName}</Link>
                        </h3>
                        ...
                        <div className="mt-3 flex justify-end">
                            <Link to={`/All_books/${book.bookId}`} className="btn btn-sm bg-green-500 text-white border-none">
                                View Details
                            </Link>
                        </div>
                    </article>
