        ...
        <div>
            ...
            >
                <article className="bg-white rounded-lg border border-gray-100 p-6 shadow-sm cursor-pointer hover:shadow-lg transition flex gap-6">
                    {/* Book Image */}
                    <div className="flex-shrink-0 w-32 h-48 bg-gray-100 rounded-lg flex items-center justify-center">
                        <img
                            src={book.image}
                            alt={book.bookName}
                    ...
                    <div className="flex-1">
                        ...
                        <div className="flex gap-3 items-center">
                            ...
                            <button className="ml-auto bg-green-500 hover:bg-green-600 text-white px-6 py-2 rounded font-semibold text-sm">
                                View Details
                            </button>
                        </div>
                    </div>
